...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.String(20), nullable=False, server_default="member", comment="角色：超级管理员/组织管理员/普通成员"),
        sa.Column("status", sa.SmallInteger(), nullable=False, server_default="1", comment="状态：1=启用 0=禁用"),
    ...
    op.create_table(
        ...
        sa.Column("categories", postgresql.JSONB(), nullable=False, comment="分类字典 JSON 数据"),
        sa.Column("status", sa.SmallInteger(), server_default="1", comment="状态：1=启用 0=禁用"),
        *soft_delete_columns(),
        *timestamps(),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("file_hash", sa.String(64), nullable=True, comment="文件 SHA-256 哈希值"),
    ...
    op.create_table(
        ...
        sa.Column("celery_task_id", sa.String(200), nullable=True, comment="异步任务 ID（Celery）"),
    ...
    op.create_table(
        ...
        sa.Column("bic", sa.Numeric(14, 2), server_default="0", comment="BIC 指标"),
        sa.Column("extra_data", postgresql.JSONB(), nullable=True, comment="扩展数据"),
    ...
    op.create_table(
        ...
        sa.Column("metric_key", sa.String(50), nullable=False, comment="调整指标：实收GMV/退货费用及其他费用"),
    ...
    op.create_table(
        ...
        sa.Column("user_agent", sa.String(500), nullable=True, comment="客户端标识"),
        sa.Column("method", sa.String(10), nullable=True, comment="HTTP 请求方法"),

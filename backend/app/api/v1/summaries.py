...
def to_summary_out(summary) -> SummaryOut:
    ...
    return SummaryOut(
        ...
        order_paid_amount=float(summary.order_paid_amount or 0),
        refund_amount=float(summary.refund_amount or 0),
...
def to_summary_report_out(row: dict) -> SummaryReportOut:
    ...
    return SummaryReportOut(
        ...
        order_paid_amount=float(row.get("order_paid_amount") or 0),

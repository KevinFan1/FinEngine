    ...
    def build_detail_payload(
        ...
        *,
        ...
        return {
            ...
            "accounting_year": detail.source_year,
            "accounting_month": detail.source_month,
            "accounting_period": period_getter(detail.source_year, detail.source_month),
            "accounting_date": f"{int(detail.source_year):04d}-{int(detail.source_month):02d}",

...
class Shop(SoftDeleteMixin, Base):
    ...
    store_long_id: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="store_long_id")
    store_short_id: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="store_short_id")
    settlement_period: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="settlement_period")
    primary_account: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="primary_account")
    ...
    purpose: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="purpose")
    former_name: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="former_name")

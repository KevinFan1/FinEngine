...
class DouyinDongzhangDetail(SoftDeleteMixin, Base):
    ...
    source_year: Mapped[int] = mapped_column(SmallInteger, nullable=False, comment="上传年月-年份")
    source_month: Mapped[int] = mapped_column(SmallInteger, nullable=False, comment="上传年月-月份")
    source_period: Mapped[int] = mapped_column(Integer, primary_key=True, nullable=False, comment="上传年月 YYYYMM")
    summary_year: Mapped[int] = mapped_column(SmallInteger, nullable=False, comment="汇总年月-年份")
    summary_month: Mapped[int] = mapped_column(SmallInteger, nullable=False, comment="汇总年月-月份")
    period_source: Mapped[str] = mapped_column(String(100), nullable=False, comment="汇总年月来源")

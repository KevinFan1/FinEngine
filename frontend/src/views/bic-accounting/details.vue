...
import { exportBicDetailsExcel, listBicDetails, type BicDetail, type BicExportScope } from "@/api/bicAccounting";
...
interface DetailFilterTag extends ActiveFilterTag {
    key: "monthRange" | "orgIds" | "platforms" | "shopNames" | "serviceProvider" | "qicWarehouse";
}
